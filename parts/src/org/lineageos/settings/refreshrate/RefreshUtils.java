...
public final class RefreshUtils {
    ...
    protected static final int STATE_MID = 3;
    protected static final int STATE_EXTREME = 4;
    protected static final int STATE_MAXIMUM = 5;
    ...
    private String getValue() {
        ...
        if (value == null || value.isEmpty()) {
            value = REFRESH_LOW + ":" + REFRESH_STANDARD + ":" + REFRESH_MID + ":" + REFRESH_EXTREME + ":" + REFRESH_MAXIMUM;
            writeValue(value);
        }
        return value;
    }
